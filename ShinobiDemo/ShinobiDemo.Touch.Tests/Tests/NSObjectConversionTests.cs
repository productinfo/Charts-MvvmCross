...
namespace ShinobiDemo.Touch.Tests
{
	...
	public class NSObjectConversionTests
	{
		...
		public void NumberTypesConvertCorrectly ()
		{
			...
			TestTypeConversion<NSNumber> (n_decimal.ConvertToNSObject ());
		}

		[Test]
		public void CharTypeCannotBeConverted()
		{
			// Chars aren't currently supported. Not sure whether they should be.
			char n_char = 'a';
			Assert.Throws<InvalidCastException> (() => n_char.ConvertToNSObject ());
		}
